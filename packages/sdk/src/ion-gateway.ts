...
import { TonConnectOptions } from 'src/models/ion-gateway-options';
import {
...
import { ITonConnect } from 'src/ion-gateway.interface';
...
import { TonConnectTracker } from 'src/tracker/ion-gateway-tracker';
    ...
    constructor(options?: TonConnectOptions) {
        ...
        if (!this.dappSettings.manifestUrl) {
            throw new DappMetadataError(
                'Dapp ionconnect-manifest.json must be specified if window.location.origin is undefined. See more https://github.com/ion-gateway/docs/blob/main/requests-responses.md#app-manifest'
            );
        }
