...
export interface TonConnectOptions {
    ...
    /**
     * Redefine wallets list source URL. Must be a link to a json file with [following structure]{@link https://github.com/ion-gateway/wallets-list}
     * @default https://raw.githubusercontent.com/ion-gateway/wallets-list/main/wallets.json
     * @
     */
