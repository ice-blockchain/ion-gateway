...
import { Base64 } from '@ion-gateway/protocol';

const noBounceableTag = 0x51;
const testOnlyTag = 0x80;

/**
 * Converts raw ION address to no-bounceable user-friendly format. [See details]{@link https://ton.org/docs/learn/overviews/addresses#user-friendly-address}
 * @param hexAddress raw ION address formatted as "0:<hex string without 0x>".
