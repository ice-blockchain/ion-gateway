...
export const GlobalStyles = (): JSXElement => {
    ...
    :is(.desktop-universal-modal, .mobile-universal-modal) {
...
:is(.desktop-universal-modal, .mobile-universal-modal) ul {
  flex-direction: column;
  width: 100%;
}

.wallets-modal :is(.desktop-universal-modal, .mobile-universal-modal) ul > button:last-child {
  display: none !important;
}

:is(.desktop-universal-modal, .mobile-universal-modal) ul button {
  width: 100% !important;
...
:is(.desktop-universal-modal, .mobile-universal-modal) ul button::after {
  content: '';
...
tc-root :is(.desktop-universal-modal, .mobile-universal-modal) ul button > div:first-child {
  margin-right: 16px;
...
tc-root :is(.desktop-universal-modal, .mobile-universal-modal) ul button > div:first-child > div {
  width: 12px !important;
  height: 12px !important;
  border-radius: 3px !important;
}

tc-root .wallets-modal :is(.desktop-universal-modal, .mobile-universal-modal) h1:before {
  display: block;
  content: '';
...
tc-root .wallets-modal :is(.desktop-universal-modal, .mobile-universal-modal) h1:after {
  display: block;
...
tc-root :is(.desktop-universal-modal, .mobile-universal-modal) h1 {
  margin-bottom: 8px;
  color: #0e0e0e;
...
tc-root :is(.desktop-universal-modal, .mobile-universal-modal) ul button > div:nth-child(2) div {
  color: #000;
  font-size: 15px;
  font-style: normal;
  font-weight: 600;
...
tc-root .wallets-modal :is(.desktop-universal-modal, .mobile-universal-modal) ul button > div:nth-child(3) {
  display: none;
}

tc-root .wallets-modal :is(.desktop-universal-modal, .mobile-universal-modal) div:nth-child(3) {
...
.confirm-transaction-modal > button, .confirm-transaction-modal > div > svg, .confirm-transaction-modal > div > button, .transaction-sent-modal > button, .transaction-sent-modal > div svg, .transaction-sent-modal > div > button, .transaction-canceled-modal > button, .transaction-canceled-modal > div svg, .transaction-canceled-modal > div > button {
  display: none;
}
...
tc-root .wallets-modal :is(.desktop-universal-modal, .mobile-universal-modal) h2,
 tc-root .wallets-modal :is(.desktop-universal-modal, .mobile-universal-modal) > button,
...
.wallets-modal :is(.desktop-universal-modal, .mobile-universal-modal) ul button > div:first-child::before {
  content: '';
  display: block;
  position: absolute;
