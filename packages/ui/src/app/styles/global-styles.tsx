...
.confirm-transaction-modal > button, .confirm-transaction-modal > div > svg, .confirm-transaction-modal > div > button,
.transaction-sent-modal  > button, .transaction-sent-modal  > div svg, .transaction-sent-modal > div > button,
.transaction-canceled-modal > button, .transaction-canceled-modal > div svg, .transaction-canceled-modal > div > button {
  display: none;
}
