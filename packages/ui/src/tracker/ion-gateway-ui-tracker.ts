...
export class TonConnectUITracker {
     ...
     * @private
     */
    private readonly eventPrefix = 'ion-gateway-ui-';
    ...
    private async setRequestVersionHandler(): Promise<void> {
        await this.eventDispatcher.addEventListener('ion-gateway-ui-request-version', async () => {
            await this.eventDispatcher.dispatchEvent(
                'ion-gateway-ui-response-version',
